...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [redkb](https://github.com/redjax/redkb)                         | My personal knowledgebase, created with [Hugo](https://gohugo.io).                                                                                                                                                                                                                                                                   |
| [PipelineTemplates](https://github.com/redjax/PipelineTemplates) | CI/CD pipeline monorepo. Includes components for Github, Forgejo, & Concourse CI platforms, including Renovate, SAST/DAST tools, linting & formatting, & more. |
| [docker_templates](https://github.com/redjax/docker_templates)   | A living history of the services I have self-hosted in my homelab. Includes instructions if you want to try any of the stacks yourself. There are <!--TEMPLATE_COUNT-->206<!--END_TEMPLATE_COUNT--> templates in the repository as of <!--TEMPLATE_DATE-->2026-08-17<!--END_TEMPLATE_DATE-->.                                                |
...
- [Renovate Automation](/posts/renovate-automation/)

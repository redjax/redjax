...
| [docker_templates](https://github.com/redjax/docker_templates)   | A living history of the services I have self-hosted in my homelab. Includes instructions if you want to try any of the stacks yourself. There are <!--TEMPLATE_COUNT-->209<!--END_TEMPLATE_COUNT--> templates in the repository as of <!--TEMPLATE_DATE-->2026-09-17<!--END_TEMPLATE_DATE-->.                                                |
